...
#BSP:modify lcm driver KGQHLWYY-1 by mingyuan.sun 20210719 start
BOOT_LOGO = fhdplus2408
#BSP:modify lcm driver KGQHLWYY-1 by mingyuan.sun 20210719 end
BUILD_AGO_GMS = no
BUILD_KERNEL = yes
BUILD_LK = yes
BUILD_MD32 = no
BUILD_PRELOADER = yes
#BSP: add project macro by wanghanfeng 20201221 start
CUSTOM_BUILD_VERNO = CY-KG7H-H6511-C
#BSP: add project macro by wanghanfeng 20201221 start
...
CUSTOM_HAL_IMGSENSOR = s5kjn1_mipi_raw s5kjn1ext2_mipi_raw gc08a3_mipi_raw ov8856ff_mipi_raw gc02m1b_mipi_raw ov02b1b_mipi_raw gc6153_serial_yuv pblcs5kjn1_mipi_raw pblcs5kjn1ext2_mipi_raw pblcgc08a3_mipi_raw pblcov8856ff_mipi_raw pblcgc02m1b_mipi_raw pblcov02b1b_mipi_raw pblcgc6153_serial_yuv
...
#BSP: modify KFLPHLEYB-1 [P1 debug] by yilong.luo for 20201228 start
CUSTOM_HAL_MSENSORLIB =
TRAN_SINGLE_ALS_CALI = yes
CUSTOM_KERNEL_STEP_DETECTOR = yes
CUSTOM_KERNEL_SENSORHUB = yes
#BSP: modify KFLPHLEYB-1 [P1 debug] by yilong.luo for 20201228 end
CUSTOM_HAL_SENSORS = sensor
#ITD:modify by camera driver team start
CUSTOM_HAL_SUB_IMGSENSOR = gc08a3_mipi_raw ov8856ff_mipi_raw
#ITD:modify by camera driver team end
...
#ITD:modify by camera driver team start
CUSTOM_KERNEL_IMGSENSOR = s5kjn1_mipi_raw s5kjn1ext2_mipi_raw gc08a3_mipi_raw ov8856ff_mipi_raw gc02m1b_mipi_raw ov02b1b_mipi_raw gc6153_serial_yuv
#ITD:modify by camera driver team end
...
#ITD:modify by camera driver team start
CUSTOM_KERNEL_SUB_IMGSENSOR = gc08a3_mipi_raw ov8856ff_mipi_raw
#ITD:modify by camera driver team end
...
#TSD: modify modem by xiaoshi.guo 20201230 start
CUSTOM_MODEM=kg7h_h6511_c1
#TSD: modify modem by xiaoshi.guo 20201230 end
...
#BSP:modify audio bring up KFLPHLEYB-2 haiping.bai 20201229 start
MTK_AUDIO_NUMBER_OF_MIC = 1
#BSP:modify audio bring up KFLPHLEYB-2 haiping.bai 20201229 end
...
MTK_BWC_SUPPORT = yes
#TDD: modify KFLPHLEYB-3 Modem P1 by xiaoshi.guo 20201230 start
MTK_C2K_LTE_MODE = 0
#TDD: modify KFLPHLEYB-3 Modem P1 by xiaoshi.guo 20201230 end
MTK_CAMERA_APP = no
...
#ITD:off MTK HDR for kf6p by sijia.feng 20210114 begin
MTK_CAM_HDR_SUPPORT = no
#ITD:off MTK HDR for kf6p by sijia.feng 20210114 end
...
#TDD:modify KFLKHLJL-147 for change sim onoff mode by qingming.song 2021.01.05 start
MTK_SIM_CARD_ONOFF = 1
#TDD:modify KFLKHLJL-147 for change sim onoff mode by qingming.song 2021.01.05 end
...
#ITD:modify for close SECURITY CAM by xiaoxue.cai 20210901 start
MTK_CAM_SECURITY_SUPPORT = no
MTK_CAM_GENIEZONE_SUPPORT = no
#ITD:modify for close SECURITY CAM by xiaoxue.cai 20210901 end
MTK_LK_VERSION = lk
...
#BSP: add project clone format by wanghanfeng 20201221 start
...
#BSP: add project clone format by wanghanfeng 20201221 end
#SDD: add project sw version by jiangping.guo 20201221 start
MTK_BUILD_VERNO=KG7h-H6511CDEF-R-OP-220303V295
TRAN_FINGERPRINT_BUILD_VERNO=220303V295
#SDD: add project sw version by jiangping.guo 20201221 end
#BSP: add project macro by wanghanfeng 20201221 start
CUSTOM_TRAN_PROJECT=tran_kg7h
CUSTOM_TRAN_BOM=tran_kg7h_c1
#BSP: add project macro by wanghanfeng 20201221 end
